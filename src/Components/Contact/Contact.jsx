    ...
    <Fragment>
      <ContactContainer>
        ...
        <ContactCard>
          ...
          <label for="email" style={{ fontSize: "22px" }}>
            Email :
          </label>
          <div
          ...
          >
            <Copypad
              id="email"
              value="soumensamanta.official@gmail.com"
              disabled
            />
            <AiOutlineCopy
              className="icon"
              onClick={() =>
                navigator.clipboard.writeText(
                  "soumensamanta.official@gmail.com"
                )
              }
            />
          </div>
          <label for="phone" style={{ fontSize: "22px", marginTop: "5px" }}>
            Contact No :{" "}
          </label>
          <div
            style={{ position: "relative", width: "100%", marginTop: "5px" }}
          ...
          <SocialTitle>Also Connect With Me on:</SocialTitle>
          <SocialLinks>
